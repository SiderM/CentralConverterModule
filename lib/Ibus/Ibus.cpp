#include "Ibus.h"
// open serial port
void Ibus::begin(HardwareSerial &userPort)
{
  serialPort = &userPort;
...
bool Ibus::transmitWaiting()
{
  return tx_msg_waiting;
}

// prepare message for transmission
void Ibus::write(uint8_t message[])
{
